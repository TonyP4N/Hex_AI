...
if __name__ == "__main__":    
    ...
    # print(HexBoard.BLUE)
    board = HexBoard(11)
    player = AlphaBetaPlayer("dijkstra", use_id=False, use_tt=True, max_depth=3, color=HexBoard.RED)
    player2 = AlphaBetaPlayer("dijkstra", use_id=False, use_tt=False, max_depth=1, color=HexBoard.BLUE)
    ...
    while not board.check_win(HexBoard.RED) and not board.check_win(HexBoard.BLUE):
        player2.do_turn()
        print(board)
        player.do_turn()
        print(board)
    ...
    # print(player.get_dijkstra_score(HexBoard.BLUE))
